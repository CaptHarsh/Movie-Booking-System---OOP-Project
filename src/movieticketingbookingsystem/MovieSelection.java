...
public class MovieSelection extends javax.swing.JFrame {
    ...
    private void AddMovieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddMovieActionPerformed
		...
		try {
			...
			FileWriter writer = new FileWriter("C:\\java\\movieticketingbookingsystem\\forprint\\print.txt", true);

					if (post == 0){
				     writer.write("TITLE: John Wick Chapter 4 ");
				     writer.write(System.getProperty("line.separator"));

		            }
			    	else if (post == 1){
					 writer.write("TITLE: Gardians Of The Galaxy Vol.3");
					 writer.write(System.getProperty("line.separator"));
					}
					else if (post == 2){
					 writer.write("TITLE: Batman");
					 writer.write(System.getProperty("line.separator"));
					}
					else if (post == 3){
					 writer.write("TITLE: Extraction");
					 writer.write(System.getProperty("line.separator"));
					}
					 else if (post == 4){
					 writer.write("TITLE: Top Gun Maveric");
					 writer.write(System.getProperty("line.separator"));
					}
					else if (post == 5){
					 writer.write("TITLE: Blade Runner 2045");
					 writer.write(System.getProperty("line.separator"));
					}
					else if (post == 6){
					 writer.write("TITLE: Doctor Strange And The Multiverse");
					 writer.write(System.getProperty("line.separator"));
					}
					else if (post == 7){
					 writer.write("TITLE: Breaking Bad");
					 writer.write(System.getProperty("line.separator"));
					}
