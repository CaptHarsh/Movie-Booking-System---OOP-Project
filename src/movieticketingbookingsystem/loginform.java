...
public class loginform extends javax.swing.JFrame {
	...
	public loginform() {
		...
		jPanelSlider1.setBackground(new Color(26, 31, 43));
	}
    ...
    private void initComponents() {
        ...
        jPanelSlider1.setBackground(new java.awt.Color(26, 31, 43));

        jPanel1.setBackground(new java.awt.Color(26, 31, 43));

        fillups.setBackground(new java.awt.Color(135, 206, 235));
        ...
        home.setBackground(new java.awt.Color(135, 206, 235));
        ...
        jPanel2.setBackground(new java.awt.Color(26, 31, 43));
        jPanel2.setForeground(new java.awt.Color(236, 240, 241));

        admin.setBackground(new java.awt.Color(135, 206, 235));
        ...
        homeform.setBackground(new java.awt.Color(135, 206, 235));
        ...
        fillup.setBackground(new java.awt.Color(135, 206, 235));
        ...
        DisplayData.setBackground(new java.awt.Color(135, 206, 235));
        ...
        clear.setBackground(new java.awt.Color(135, 206, 235));
        ...
        MovieSelection.setBackground(new java.awt.Color(135, 206, 235));
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
		...
		if(username.contains("mihir") && password.contains("root")){ 
    ...
    private void fillupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fillupActionPerformed
		...
		try {
			FileWriter writer = new FileWriter("C:\\java\\movieticketingbookingsystem\\forprint\\userinfo.txt", true);
			writer.write(id);
			writer.write("   /  ");
			writer.write(fname);
			writer.write("   /  ");
    ...
    private void DisplayDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayDataActionPerformed
		try {
			String filePath = "C:\\java\\movieticketingbookingsystem\\forprint\\userinfo.txt";
